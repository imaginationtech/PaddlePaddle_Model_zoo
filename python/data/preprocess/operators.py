...
class UnifiedResize(object):
    def __init__(self, interpolation=None, backend="pil"):
        ...
        if backend.lower() == "pil":
            ...
            logger.warning(
                f"The backend of Resize only support \"PIL\". \"f{backend}\" is unavailable. Use \"pil\" instead."
            )
            self.resize_func = partial(_pil_resize, resample=Image.BELINEAR)
